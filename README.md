...
TSHAP is a SHAP-based attribution method for time series classification and regression. 
The attributions can be used to explain the prediction of the time series model. 
TSHAP has two variants: TSHAP-Window and TSHAP-ROI. 
It supports both univariate and multivariate time series data for the tasks of classification and extrinsic regression.
